...
| SIM-03 | load_regulation | [5 V](ltspice/SIM-03_calibrated_load_5V.asc), [3.3 V](ltspice/SIM-03_calibrated_load_33V.asc) | Circuito completo calibrado, cinco cargas verificadas; control adicional de 1 us no completado; el paso nominal de 2 us se justifica para medias asentadas en [esta nota](tests/SIM-03_load_regulation/NUMERICAL_SCOPE.md). Figura y tabla integradas. Ver tests/SIM-03_load_regulation/CALIBRATED_LOAD.md. |
