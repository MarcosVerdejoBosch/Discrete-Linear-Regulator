...
for name,label,color in [('original',r'Original: $R_{21}=10\,\Omega$','#0072B2'),('R100_candidate',r'Candidate: $R_{21}=100\,\Omega$','#009E73')]:
...
fig.legend(handles[:2],labels[:2],loc='upper left',bbox_to_anchor=(.12,.865),ncol=2,fontsize=8,frameon=False)
...
fig.text(.12,.90,'Settled means; connecting lines are guides. R21 = 100 ohm is simulation-only.',fontsize=8)
